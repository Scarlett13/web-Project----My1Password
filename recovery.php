...
<div class="container theme-showcase">
    ...
    3. If the version number of the backup file is the same with the version number of this My 1Password (shown in the login page), go to step 6.<br />
    4. Go <a href="https://github.com/zeruniverse/My 1Password/releases">here</a> and find the My 1Password release with the same version number as your backup file.<br />
    5. Download the My 1Password with the right version, use its src/recovery.php instead of this one.<br />
